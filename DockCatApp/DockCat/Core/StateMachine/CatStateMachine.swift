...
final class CatStateMachine {
    ...
    func enterManualLongDurationState(_ selectedState: LongDurationState) {
    ...
    func endDrag(at point: CGPoint, returningTo selectedState: LongDurationState? = nil) {
        guard case .dragged = state else { return }
        position = point
        if let selectedState {
            enterManualLongDurationState(selectedState)
        } else {
            enterRandomLongDurationStateWithOptionalTransition()
        }
    }
    ...
    func finishReminder(returningTo selectedState: LongDurationState? = nil) {
    ...
    func welcomeBack(returningTo selectedState: LongDurationState? = nil) {
