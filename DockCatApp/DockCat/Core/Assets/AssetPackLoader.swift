...
final class AssetPackLoader {
    ...
    func loadDefaultPack() -> CatAssetPack {
        ...
        let fallbackManifest = AssetManifest(
            id: "default-lizz",
            name: "喵心心",
            author: "Personal edition based on DockCat by Auwuua",
            profile: .init(
                species: .cat,
                breed: "Munchkin",
                bodyTraits: ["short_legs", "round_face"],
                identityFeatures: ["gray_and_white_coat", "golden_round_eyes", "blue_bead_collar"],
                motionNotes: ["short_stride", "alternating_paw_contact"]
            ),
            canvasWidth: 1280,
            canvasHeight: 1280,
    ...
    func customPacksRoot() -> URL {
        ...
        return appSupport.appendingPathComponent("MiaoXinxin/CatPacks", isDirectory: true)
    }
    ...
    private func createTemplateDirectories(at root: URL) throws {
        for path in [
            ...
            "animations/play_toy",
            "animations/grooming",
            "animations/belly_roll",
            "animations/sleep_curled",
            "animations/sleep_side",
            "animations/sleep_loaf",
            "animations/eating",
            "animations/drinking",
            "animations/pet_response",
            "animations/look",
            "animations/pounce",
            "app_icons"
        ] {
    ...
    private func isDefaultLizzManifest(_ manifest: AssetManifest) -> Bool {
        manifest.id == "default-lizz"
            && manifest.name == "喵心心"
            && manifest.author == "Personal edition based on DockCat by Auwuua"
            ...
            && manifest.animations == .init(walk: .init(fps: 6, frames: []))
    }
    ...
    private func defaultLizzManifestData(withAppIcons: Bool) throws -> Data {
        ...
        return Data("""
        {
          ...
          "profile": {
            "species": "cat",
            "breed": "Munchkin",
            "body_traits": ["short_legs", "round_face"],
            "identity_features": ["gray_and_white_coat", "golden_round_eyes", "blue_bead_collar"],
            "motion_notes": ["short_stride", "alternating_paw_contact"]
          },
          "canvas_width": 1280,
          "canvas_height": 1280,
          "default_anchor": {
          ...
          "animations": {
            ...
            "behaviors": {
              "play_toy": {"fps": 2.2, "frames": [], "playback_loops": 2, "autonomous_weight": 1.0},
              "grooming": {"fps": 2.5, "frames": [], "playback_loops": 2, "autonomous_weight": 0.8},
              "belly_roll": {"fps": 1.9, "frames": [], "playback_loops": 1, "autonomous_weight": 0.65},
              "sleep_curled": {"fps": 1.4, "frames": [], "sleep": true, "autonomous_weight": 0.7},
              "sleep_side": {"fps": 1.4, "frames": [], "sleep": true, "autonomous_weight": 0.7},
              "sleep_loaf": {"fps": 1.4, "frames": [], "sleep": true, "autonomous_weight": 0.7},
              "eating": {"fps": 2.0, "frames": [], "playback_loops": 2, "autonomous_weight": 0.65},
              "drinking": {"fps": 2.0, "frames": [], "playback_loops": 2, "autonomous_weight": 0.65},
              "pet_response": {"fps": 2.2, "frames": [], "playback_loops": 1, "autonomous_weight": 0.0}
            }
        \(iconsBlock)
          }
        }
        ...
        Data("""
        {
          ...
          "animations": {
            ...
            "behaviors": {
              ...
              "drinking": {"fps": 2.0, "frames": [], "playback_loops": 2, "autonomous_weight": 0.65},
              "pet_response": {"fps": 2.2, "frames": [], "playback_loops": 1, "autonomous_weight": 0.0},
              "pounce": {"fps": 2.4, "frames": [], "playback_loops": 2, "autonomous_weight": 0.8}
            }
          },
          "app_icons": {
            "sleep": "app_icons/icon_sleep.png",
